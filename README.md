...
`pnpm dev` runs the frontend in a browser — great for UI work, but real playback and live sources need the native layer. For the real thing, from `apps/app`:
