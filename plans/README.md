...
| [013](013-multiview.md) | Multiview: two to four sports at once | MEDIUM | REDIRECTED to a web player (Telly confirmed web; CORS probe shipped v0.9.50, proxy decision pending) |
