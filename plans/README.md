...
| [013](013-multiview.md) | Multiview: two to four sports at once | MEDIUM | REDIRECTED to a web player (web player confirmed, CORS allows direct read so NO proxy needed; grid is next) |
