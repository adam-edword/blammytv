...
| [013](013-multiview.md) | Multiview: two to four sports at once | MEDIUM | REDIRECTED to a web player (Telly confirmed web; probe + notice shipped v0.9.50-51, grid next, proxy decision pending) |
