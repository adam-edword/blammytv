...
| [017](017-multiview-design.md) | Multi-view, designed: an immersive mode, 16:9 tiles with info and controls, a search-first picker | HIGH | IN PROGRESS (decided 2026-09-24; P1, the tab and its layouts, in v0.9.105; P2, the tile, in v0.9.107; P3, picking and limits, next) |
