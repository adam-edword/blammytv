...
function ComboboxChipsInput({
  className,
  // Destructured to SWALLOW it: an <input> is void, so children reaching
  // it would throw. Underscored only because this repo's eslint flags an
  // unused binding and the registry's does not; the behaviour is the
